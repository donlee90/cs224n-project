...
# and target size equal encoder size plus 1. For simplicity, here I droped the last one. #BK: this means that decoder_inputs is like 0, X, Y.
decoder_inputs = ([tf.zeros_like(encoder_inputs[0], name="GO")] + encoder_inputs[:-1])
#BK: target is equal to encoder_inputs because we are building an autoencoder.
